# -*- coding: utf-8 -*-
"""
Created on Sun May 29 14:18:19 2022
...
#Gerekli model ve yöntemlerin import edilmesi
...
data = pd.read_csv("auto-mpg.data.py", names = column_name, na_values = "?", comment = "\t",sep = " ", skipinitialspace = True)
